        ...
        {selectedTeacher && (
          <>
            ...
            >
              ...
              {success ? (
                <div className="bg-emerald-50 text-emerald-700 p-6 rounded-2xl text-center border border-emerald-200 shadow-sm animate-in fade-in zoom-in duration-300">
                  <div className="w-14 h-14 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-3 text-emerald-600 shadow-inner">
                  ...
                  <h3 className="font-bold text-xl mb-1 text-emerald-900">AI Audit Passed & Submitted!</h3>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <button 
                    type="submit" 
                    disabled={loading}
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl shadow-[0_4px_14px_0_rgba(37,99,235,0.39)] transition-all disabled:opacity-70 mt-2 flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
                        ...
                        <span>AI Auditing & Encrypting...</span>
                      </>
                    ) : (
