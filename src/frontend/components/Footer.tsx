        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div className="flex flex-col gap-6 lg:col-span-1">
            ...
            <div className="flex items-center gap-4 mt-2">
              <a href="https://www.facebook.com/mbmanepal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-800/50 flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white transition-all border border-white/5 hover:border-transparent hover:-translate-y-1">
