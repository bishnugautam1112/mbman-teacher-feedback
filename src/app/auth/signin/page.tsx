      ...
      >
        ...
        {(tab === "LOGIN" || (tab === "REGISTER" && step === "DETAILS")) && (
          <>
            ...
            <button className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 text-slate-700 font-bold py-3 rounded-xl hover:bg-slate-50 transition-all shadow-sm hover:shadow">
